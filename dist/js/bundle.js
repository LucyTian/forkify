...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config */ \"./src/js/config.js\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n// Global app controller\n//https://www.food2fork.com/api/search\n// 15a999ab5145c41a4ae3f4a4cc18ff0b\n\n\n\nfunction getResults(_x) {\n  return _getResults.apply(this, arguments);\n}\n\nfunction _getResults() {\n  _getResults = _asyncToGenerator(\n  /*#__PURE__*/\n  regeneratorRuntime.mark(function _callee(query) {\n    var key, res;\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            key = _config__WEBPACK_IMPORTED_MODULE_1__[\"default\"].KEY;\n            console.log(\"\".concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"default\"].PROXY).concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"default\"].URL, \"?key=\").concat(key, \"&q=\").concat(query));\n            _context.next = 4;\n            return axios__WEBPACK_IMPORTED_MODULE_0___default()(\"\".concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"default\"].PROXY).concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"default\"].URL, \"?key=\").concat(key, \"&q=\").concat(query));\n\n          case 4:\n            res = _context.sent;\n            console.log(res);\n\n          case 6:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, this);\n  }));\n  return _getResults.apply(this, arguments);\n}\n\ngetResults('pizza');\n\n//# sourceURL=webpack:///./src/js/index.js?");
